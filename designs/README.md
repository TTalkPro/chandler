...
| [00-design-principles.md](00-design-principles.md) | 核心模型 + 6 不变量 + 术语表(v3+v4 宪法,已对齐 06) | 必读 |
| [01-manifest-lock.md](01-manifest-lock.md) | `chandler-manifest.ss` / `chandler-manifest.lock` schema | 数据 |
| [02-resolution.md](02-resolution.md) | 依赖解析:BFS 闭包 + 冲突裁决 + 多版本语义 | 数据 |
| [03-central-repo.md](03-central-repo.md) | 中央仓库布局(中心 `.registry/` 取代 per-version registry) | 数据 |
