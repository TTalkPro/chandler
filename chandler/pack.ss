...
(library (chandler pack)
  ...
  (define (bootstrap-source entry main-proc ver mt libdirs)
    (string-append
      ";; generated by chandler pack -- do not edit\n"
      bootstrap-root-src
      stderr-diag-src
      ...
      ;; v2 nested:layout: libdirs 来自 pack 运行时构造,包含 app + deps + chandler
      ;; 的所有 (src . obj) 对(designs/05 §P1)。
  ...
  (define (pack project opts)
    (let* ([mpath (project-manifest-path project)]
      ...
      (let* ([locked (project-locked-deps project)]
        ...
        (write-text (join-paths root "bootstrap.ss") (bootstrap-source entry mainp #f mt libdirs-str)))
        ;; 3) 运行时 + boot + 启动器 + 清单
        (if (eq? rt 'skiff)
